...
$query_rs_quangcao = "SELECT ID_quangcao, tieude, taptinquangcao, url, target, fileflash, rand() AS songaunhien FROM quangcao WHERE visible = 1 ORDER BY songaunhien ASC LIMIT 0,2";
