...
?><br>
            ...
            <td>
              <a class="KT_edit_link" href="managercp.php?vietchuyen=form_tintuc&ID_tintuc=<?php echo $row_rstintuc1['ID_tintuc']; ?>&KT_back=1"><?php echo NXT_getResource("edit_one"); ?></a>
...
<?php } // Show if recordset not empty ?>
      ...
      <div class="KT_bottombuttons">
        ...
        <a class="KT_additem_op_link" href="managercp.php?vietchuyen=form_tintuc&KT_back=1" onclick="return nxt_list_additem(this)"><?php echo NXT_getResource("add new"); ?></a>
      </div>
    </form>
  </div>
