...
$query_rs_nhomtin = "SELECT ID_nhomtin, tennhomtin, ID_theloai FROM nhomtin WHERE visible = 1 ORDER BY ngaycapnhat DESC LIMIT 0,4";
        	...
        	<span class="linkden">
            	<!--<a href="layout_cactinchuyende.php?chuyende=<?php echo $row_rs_nhomtin['ID_nhomtin']; ?>">-->	
                	<a href="<?=$url?>chuyende<?=$row_rs_nhomtin['ID_nhomtin'];?>/<?=vietdecode($row_rs_nhomtin['tennhomtin']);?>.html">
															<?php echo $row_rs_nhomtin['tennhomtin']; ?></a>	
            </span>
        </header>
