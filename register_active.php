...
function Trigger_CheckPasswords(&$tNG) {
  ...
  $myThrowError->setErrorMsg("Passwords nhập 2 lần phải giống nhau");
  $myThrowError->setField("password");
  $myThrowError->setFieldErrorMsg("Passwords nhập 2 lần phải giống nhau");
...
function Trigger_ActivationEmail(&$tNG) {
  ...
  $emailObj->setCC("");
  $emailObj->setBCC("");
  $emailObj->setSubject("Learn Online Activation");
  //FromFile method
...
$formValidation->addField("username", true, "text", "", "", "", "Xin vui lòng nhập vào username");
...
$userRegistration->addColumn("ngaycapnhat", "DATE_TYPE", "POST", "ngaycapnhat", "{NOW_DT}");
...
?>
	...
	<td>
		...
		<?php echo $tNGs->displayFieldError("thanhvien", "hoten"); ?>	</td>
		  ...
		  <tr>
	<td class="KT_th"><label for="diachi">Địa chỉi:</label></td>
	<td>
	...
	<td>
		...
		<?php echo $tNGs->displayFieldError("thanhvien", "gioitinh"); ?>	</td>
		  ...
		  <tr>
	<td class="KT_th"><label for="ID_quequan">Quê quán:</label></td>
	<td>
...
?>
		...
		<?php echo $tNGs->displayFieldError("thanhvien", "ID_quequan"); ?>	</td>
		  ...
		  <tr>
	<td class="KT_th"><label for="ID_nghenghiep">Nghề nghiệp:</label></td>
	<td>
...
<tr>
	...
	<td>
		...
		<?php echo $tNGs->displayFieldError("thanhvien", "ngaysinh"); ?>	</td>
		  ...
		  <tr>
	<td class="KT_th"><label for="chuthich">Chú thích:</label></td>
	<td>
