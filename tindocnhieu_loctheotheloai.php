...
$query_rs_tindocnhieu = sprintf("SELECT theloai.ID_theloai, theloai.tentheloai, theloai.keyword, tintuc.ID_tintuc, tintuc.tieudetin, tintuc.solandoc, tintuc.kiemduyet, tintuc.ngaycapnhat FROM (tintuc LEFT JOIN theloai ON theloai.ID_theloai=tintuc.ID_theloai) WHERE theloai.keyword=%s  AND tintuc.kiemduyet=1  LIMIT 0,5", GetSQLValueString($KTColParam1_rs_tindocnhieu, "text"));
